...
import com.zkt.project.biology.service.QueryAllOrderService;
 ...
 */
@RestController
@Api(value="QueryAllOrderController| 查询全部订单")
@RequestMapping(value = "/api/bio/queryAllOrder")
public class QueryAllOrderController {

	private Logger log = LoggerFactory.getLogger(QueryAllOrderController.class);

	@Autowired
	private QueryAllOrderService queryAllOrderService;
	...
	public ReturnObjectHandle search() {
		...
		return queryAllOrderService.search(json);
	}
	...
	public ReturnSimpleHandle detail() {
		JSONObject json = ContainerContent.clientWebReceive();
		return queryAllOrderService.detail(json);
	}
	...
	public ReturnSimpleHandle delete() {
		JSONObject json = ContainerContent.clientWebReceive();
		return queryAllOrderService.delete(json);
	}
	...
	public void exportpass() {
		...
		try {
			...
			ReturnObjectHandle handle = queryAllOrderService.search(infoList);
