...
import com.zkt.project.biology.service.QueryExceptionOrderService;
...
public class QueryExceptionOrderController {
	...
	@Autowired
	private QueryExceptionOrderService queryExceptionOrderService;
	 ...
	 * @return
	 */
	@PostMapping(value = "/searchProblemmonitor")
	@ApiOperation(value="查询运输异常订单",tags = "查询运输异常订单")
	public ReturnObjectHandle searchProblemmonitor() {
		JSONObject json = ContainerContent.clientWebReceive();
		return queryExceptionOrderService.searchProblemmonitor(json);
	}
	...
	@ApiOperation(value="查询接收异常订单",tags = "查询接收异常订单")
	public ReturnObjectHandle search() {
		JSONObject json = ContainerContent.clientWebReceive();
		return queryExceptionOrderService.search(json);
	}
	 ...
	 * @return
	 */
	@PostMapping(value = "/detailProblemmonitor")
	@ApiOperation(value="运输异常订单详情",tags = "运输异常订单详情")
	public ReturnSimpleHandle detailProblemmonitor() {
		JSONObject json = ContainerContent.clientWebReceive();
		return queryExceptionOrderService.detailProblemmonitor(json);
	}
	...
	@ApiOperation(value="接收异常订单详情",tags = "接收异常订单详情")
	public ReturnSimpleHandle detail() {
		JSONObject json = ContainerContent.clientWebReceive();
		return queryExceptionOrderService.detail(json);
	}
	 ...
	 * @return
	 */
	@PostMapping(value = "/saveDiscribtion1")
	@ApiOperation(value="提交运输异常订单回复",tags = "提交运输异常订单回复")
	public ReturnSimpleHandle saveDiscribtion1() {
		JSONObject json = ContainerContent.clientWebReceive();
		return queryExceptionOrderService.saveDiscribtion1(json);
	}
	 ...
	 * @return
	 */
	@PostMapping(value = "/saveDiscribtion")
	@ApiOperation(value="提交接收异常订单回复",tags = "提交接收异常订单回复")
	public ReturnSimpleHandle saveDiscribtion() {
		JSONObject json = ContainerContent.clientWebReceive();
		return queryExceptionOrderService.saveDiscribtion(json);
	}
	...
	@RequestMapping(value = "/exportProblemmonitor", method = RequestMethod.POST)
	public void exportProblemmonitor() {
		...
		try {
			...
			ReturnObjectHandle handle = queryExceptionOrderService.searchProblemmonitor(infoList);
			...
			String[] headers = { "订单编号", "处理状态", "上报时间"};
			String[] fieldName = { "orderNo", "status", "createdAt"};
	...
	public void exportpass() {
		...
		try {
			...
			JSONObject infoList = json.getJSONObject("infoList");
			infoList.put("isExport", 'Y');
			ReturnObjectHandle handle = queryExceptionOrderService.search(infoList);
