...
import com.zkt.project.biology.service.QueryInTransportOrderService;
...
public class QueryInTransportOrderController {
	...
	@Autowired
	private QueryInTransportOrderService queryInTransportOrderService;
	...
	@ApiOperation(value="查询在途订单",tags = "查询在途订单")
	public ReturnObjectHandle search() {
		JSONObject json = ContainerContent.clientWebReceive();
		return queryInTransportOrderService.search(json);
	}
	...
	@ApiOperation(value="在途订单详情",tags = "在途订单详情")
	public ReturnSimpleHandle detail() {
		JSONObject json = ContainerContent.clientWebReceive();
		return queryInTransportOrderService.detail(json);
	}
	...
	public void exportpass() {
		...
		try {
			...
			ReturnObjectHandle handle = queryInTransportOrderService.search(infoList);
			...
			String[] fieldName = { "orderNo", "sender", "transport", "reciver", "packOperator", "transportOperator", "receiveOperator", "orderStatus" };
