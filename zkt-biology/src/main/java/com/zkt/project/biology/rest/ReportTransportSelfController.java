...
import com.zkt.project.biology.service.ReportTransportSelfService;
...
@RequestMapping(value = "/api/bio/reportTransportSelf")
public class ReportTransportSelfController {

	private Logger log = LoggerFactory.getLogger(ReportTransportSelfController.class);

	@Autowired
	private ReportTransportSelfService reportTransportSelfService;
	...
	public ReturnObjectHandle search() {
		...
		return reportTransportSelfService.search(json);
	}
	...
	public ReturnSimpleHandle detail() {
		...
		return reportTransportSelfService.detail(json);
	}
	...
	public void exportpass() {
		...
		try {
			...
			ReturnObjectHandle handle = reportTransportSelfService.search(infoList);
