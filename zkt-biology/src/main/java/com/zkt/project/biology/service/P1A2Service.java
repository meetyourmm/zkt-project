...
public class P1A2Service {
	...
	public String search(JSONObject json) throws Exception {
		...
		map.put("area", json.getString("area"));//区
		
		//默认选择区级账号
		map.put("userType", Constant.USER_TYPE_AREA);
	...
	public String saveServer(JSONObject json) throws Exception {
		...
		logins.setUserType(Constant.USER_TYPE_AREA);//用户类型
		...
		// 默认区级权限
		//运单信息监控:"m3","m31","m32","m35","m36","m37"	异常件仲裁(区级):"m4","m41","m43","m45"	报表信息管理:"m6","m61"	 个人信息管理:"m8","m81","m82"
		String[] menus = {"m3","m31","m32","m35","m36","m37","m4","m41","m43","m45","m6","m61","m8","m81","m82" };
